  ...
  return (
    <>
      <div className="flex justify-between items-center p-5 w-full sm:w-[98%] m-auto">
        ...
        <div className={`absolute bg-white left-0 w-full md:static md:w-auto ${Open ? "top-[95px]" : "top-[-100%]"} transition-all duration-500 ease-in`}>
        ...
        <div className="login-cart flex items-center gap-3 sm:gap-5">
          ...
          <div className="cart flex flex-cols justify-around items-center font-semibold gap-1">
            ...
            <span className="text-sm align-top bg-red-500 rounded-xl p-1 mb-7 text-white">{totalItemQuantity}</span>
            <i onClick={() => setOpen(!Open)} className={`${Open ? "fa-solid fa-xmark":"fa-solid fa-bars"}  ml-2 sm:text-xl md:text-2xl md:hidden`} ></i>
          </div>
        </div>
